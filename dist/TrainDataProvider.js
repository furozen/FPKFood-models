...
class TrainDataProvider {
    ...
    getTrainTrackByNumber(number) {
        const trains = [
            {
                ...
                stations: [
                    ...
                    { name: "Ишим", arrive: 1000, left: 1005, day: 1 },
                    { name: "Омск", arrive: 1320, left: 1401, day: 1 },
                    { name: "Барабинск", arrive: 1727, left: 757, day: 1 },
                    { name: "Новосибирск", arrive: 2126, left: 2144, day: 1 },
                    { name: "Новосибирск-Главный", arrive: 2126, left: 144, day: 1 },
                    { name: "Юрга", arrive: 2352, left: 2354, day: 1 },
                    { name: "Юрга-1", arrive: 2352, left: 2354, day: 1 },
                    ...
                    { name: "Канск-Енисейский", arrive: 1302, left: 1303, day: 2 },
                    { name: "Иланская", arrive: 1337, left: 1357, day: 2 },
                    { name: "Тайшет", arrive: 1555, left: 1557, day: 2 },
                    { name: "Нижнеудинск", arrive: 1825, left: 838, day: 2 },
                    { name: "Тулун", arrive: 2017, left: 2019, day: 2 },
                    { name: "Зима", arrive: 2215, left: 2245, day: 2 },
                    ...
                    { name: "Улан-Удэ", arrive: 956, left: 917, day: 3 },
                    { name: "Улан-Удэ Пасс.", arrive: 956, left: 917, day: 3 },
                    { name: "Петровский Завод", arrive: 1218, left: 1220, day: 3 },
                    { name: "Хилок", arrive: 1447, left: 1508, day: 3 },
                    { name: "Чита", arrive: 1911, left: 1947, day: 3 },
                    { name: "Чита-2", arrive: 1911, left: 1947, day: 3 },
                    { name: "Карымская", arrive: 2132, left: 2150, day: 3 },
                    ...
                    { name: "Амазар", arrive: 1025, left: 1043, day: 4 },
                    { name: "Ерофей Павлович", arrive: 1237, left: 1258, day: 4 },
                    { name: "Сковородино", arrive: 1625, left: 1628, day: 4 },
                    { name: "Магдагачи", arrive: 1932, left: 1947, day: 4 },
                    { name: "Тыгда", arrive: 2046, left: 2048, day: 4 },
                    { name: "Шимановская", arrive: 2259, left: 2301, day: 4 },
                    { name: "Ледяная", arrive: 2338, left: 2340, day: 4 },
        ...
        const train = trains.filter((train) => train.number === number);
        return train[0];
    }
}
exports.TrainDataProvider = TrainDataProvider;
//# sourceMappingURL=TrainDataProvider.js.map